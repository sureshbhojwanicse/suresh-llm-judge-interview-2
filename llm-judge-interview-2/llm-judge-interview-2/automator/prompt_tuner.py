...
if __name__ == "__main__":
    ...
    prompt_tuner = PromptTuner(
        ...
        train_df_path="/home/anon/freelancing/mercor_mle/llm-judge-interview-2/llm-judge-interview-2/data/mercor_mle/test-2024-05-14-21-11/enriched_judgments.csv",
        test_size=0.1,
    )
